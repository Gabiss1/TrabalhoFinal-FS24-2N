...
public class TreinadorPanel extends JInternalFrame {
    ...
    public TreinadorPanel(TreinadorController controller) {
    ...
    private void carregarTreinadoresNaTabela() {
        ...
        List<Treinador> treinadores = controller.listarTreinadores();
    ...
    private void removerTreinadorSelecionado() {
        ...
        if (selectedRow >= 0) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                try {
                    controller.removeTreinador(idTreinador, nome);
    ...
    private void buscarTreinadoresPorNome() {
        ...
        Treinador treinador = controller.buscarTreinadorPorNome(nomeBusca);
    ...
    private void editarTreinadorSelecionado() {
        ...
        if (selectedRow >= 0) {
            ...
            TreinadorForm cadastroTreinador = new TreinadorForm(controller, idTreinador);
